...
public class AprendeDesarrollateApplication {
	...
	public CommandLineRunner initData(RepositorioProductos repositorioProductos){
		return (args) ->{
			...
			Productos producto2 = new Productos("Curso Cocina Vegana","Aprende diversas preparaciones para una alimentación mas consciente.","","./assests/imagenes/COCINA VEGANA.png","./assests/imagenes/bannerCocinaVegana.jpg","./assests/imagenes/certificadoComidaVegana.png","./assests/imagenes/bookVegetariona.png","", Categoria.COMIDA, true);
